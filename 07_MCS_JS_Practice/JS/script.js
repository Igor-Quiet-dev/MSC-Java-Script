...
const ColoredFontPage = document.querySelector('.page');
...
let questColoredFontPage                  = prompt('Какой будет фон у страницы?');
    ColoredFontPage.style.backgroundColor = questColoredFontPage;

let questColoredFontPage        = prompt('Какой будет цвет текста на странице?');
    ColoredFontPage.style.color = questColoredFontPage;
